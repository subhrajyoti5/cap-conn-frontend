...
function GradientCanvas({ color1, color2, speed = 1 }) {
  ...
  return (
    ...
    >
      ...
      {(title1 || title2 || description || children) && (
        <div className="relative z-10 w-full flex-1 flex flex-col items-center justify-center pt-20 pb-8 md:pt-28 md:pb-20">
              ...
              {title1 && (
                <div className="overflow-hidden pb-3 -mb-3">
                  <motion.h1
                    ...
                    className="text-[12cqi] md:text-[8cqi] lg:text-[6cqi] leading-[1.05] tracking-tighter text-[#131313]"
                  >
              ...
              {title2 && (
                <div className="overflow-hidden pb-3 -mb-3">
                  <motion.h1
                    ...
                    className="text-[12cqi] md:text-[8cqi] lg:text-[6cqi] leading-[1.05] tracking-tighter font-bold text-black"
                  >
                    {title2}
                  </motion.h1>
                </div>
