...
export function Sidebar({ role, mobileOpen, onMobileClose }) {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside className="hidden lg:flex flex-col w-60 border-r border-border-warm bg-white shrink-0">
        <div className="gradient-accent-bar h-0.5" />
        {navContent}
      ...
      {mobileOpen && (
        <>
          <div
            ...
            onClick={onMobileClose}
          />
          <aside className="fixed inset-y-0 left-0 w-60 bg-white border-r border-border-warm z-50 flex flex-col lg:hidden">
            <div className="gradient-accent-bar h-0.5" />
