        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {certifications.map((cert, index) => {
            ...
            return (
              ...
              >
                <div className="card p-6 h-full flex flex-col justify-between border border-border bg-card hover:shadow-lg transition-all duration-200">
                  <div>
                    ...
                    <h3 className="font-semibold text-base text-foreground mb-1 line-clamp-2">{cert.name}</h3>
                    <p className="text-xs font-medium text-muted-foreground mb-4">{cert.issuer}</p>
                  ...
                  <div className="mt-5 pt-3 border-t border-border flex items-center justify-between gap-2">
                    {hasDriveLink ? (
                      ...
                      <span className="text-xs text-muted-foreground">No URL attached</span>
                    )}
                  </div>
                </div>
              </div>
