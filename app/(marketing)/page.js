  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden py-18 lg:py-24">
        <div className="page">
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/sign-up" className="btn-primary-lg shadow-lg shadow-accent/25">
              Get Started
            </Link>
      ...
      <section id="features" className="page py-18 lg:py-24">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {FEATURES.map((f, index) => (
            <div key={f.title} className="card-shell group" style={{ animationDelay: `${index * 80}ms` }}>
              <div className="card p-6 h-full bg-card border border-border hover:border-accent/40 transition-all duration-300">
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            {STEPS.map((s, index) => (
              <div key={s.step} style={{ animationDelay: `${index * 80}ms` }}>
                <p className="font-mono text-4xl text-accent font-medium mb-3">{s.step}</p>
      ...
      <section className="page py-18 lg:py-24">
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-accent/10 to-primary/10 border border-accent/20 p-10 sm:p-14 text-center shadow-xl">
