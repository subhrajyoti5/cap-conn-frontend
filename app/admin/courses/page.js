...
import { BookOpen, Search, Filter, Plus, ArrowRight, UserCheck, Shield } from "lucide-react";
          ...
          {filteredCourses.map((course, idx) => {
            ...
            return (
              <Link
                ...
                className="group bg-card border border-border/80 rounded-2xl overflow-hidden hover:border-amber-500/50 hover:shadow-xl transition-all flex flex-col justify-between h-[270px]"
              >
                ...
                <div className="p-4 space-y-3 flex-1 flex flex-col justify-between bg-card text-foreground">
                  <p className="text-xs text-muted-foreground line-clamp-2 leading-relaxed">
                    {course.description || "Course description and learning content."}
                  </p>

                  <div className="pt-3 border-t border-border/60 flex items-center justify-between text-xs">
                    <div className="flex items-center gap-1.5 min-w-0">
                      <div className="w-5 h-5 rounded-full bg-amber-500/10 text-amber-600 dark:text-amber-400 flex items-center justify-center font-bold text-[10px] shrink-0 border border-amber-500/20">
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                      ...
                      <span className="font-semibold text-amber-600 dark:text-amber-400 flex items-center gap-1 group-hover:translate-x-1 transition-transform">
